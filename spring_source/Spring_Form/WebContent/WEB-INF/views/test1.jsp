...
<hr />
hobby3: <form:checkboxes items="${job_list3 }" path="job3"
			itemLabel="key" itemValue="value" /> <br />
<hr />
...
<hr />
gender3: <form:radiobuttons path="job3" items="${job_list3 }"
			itemLabel="key" itemValue="value" /> <br />
<hr />
...
최종학력1: <form:radiobuttons path="level" items="${level_list }" />
