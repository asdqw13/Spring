...
public class TestController2 {
	...
	@GetMapping("/test4")
	public String test4(Model model, UserDataBean bean) {
	...
	@GetMapping("/test5")
	public ModelAndView test5(ModelAndView mv, UserDataBean bean) {
...
//	@PostMapping("/test6")
//	public String test6(Model model, UserDataBean bean) {
//		bean.setUser_address("서울");
//		
//		model.addAttribute("bean6", bean);
//		return "test6";
//	}
